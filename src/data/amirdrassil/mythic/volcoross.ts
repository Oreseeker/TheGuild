...
export const mythicVolcoross: Encounter = {
  name: volcoross.name,
  img: volcoross.image,
  defeated: true,
  datetime: '2024-01-07T19:06:00.000Z',
  warcraftLogsLink: 'https://www.warcraftlogs.com/reports/69d4XLmPQGv1Yfj2#fight=last',
  pugs: {
    healers: 1,
  },
  participants: [
